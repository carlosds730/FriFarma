...
(function (a) {
    ...
    a.extend(a.jqx._jqxMenu.prototype, {
        defineInstance: function () {
            ...
            this.animationHideDuration = 100;
            ...
            if (l != null) {
                ...
                var o = function () {
                    ...
                    if (b) {
                        ...
                        k.stop().animate({top: n}, m.animationHideDuration, function () {
                        ...
                        k.stop().animate({left: e}, m.animationHideDuration, function () {
                            if (m.animationHideDuration == 0) {
                                k.css({left: e})
                            }
                            if (p.level > 0) {
            ...
            p.css({height: parseInt(u.outerHeight()) + parseInt(f[1]) + "px"});
            var o = 0;
            var g = 0;
            switch (s.openVerticalDirection) {
                case"up":
                    if (k) {
                        ...
                        p.css({display: "block", top: j.top - p.outerHeight(), zIndex: m})
                    } else {
                        o = f[1];
                        u.css("top", u.outerHeight());
                        p.css({display: "block", top: j.top - p.outerHeight() + f[1] + h.outerHeight(), zIndex: m})
                    }
                    break;
                case"center":
                    if (k) {
                        u.css("top", 0);
                        p.css({display: "block", top: j.top - p.outerHeight() / 2 + f[1], zIndex: m})
                    } else {
                        u.css("top", 0);
                        p.css({
                            display: "block",
            ...
            switch (s.openHorizontalDirection) {
                case this._getDir("left"):
                    if (k) {
                        p.css({left: j.left - (p.outerWidth() - h.outerWidth() - f[0])})
                    } else {
                        g = 0;
                        u.css("left", p.outerWidth());
                        p.css({left: j.left - (p.outerWidth()) + 2 * s.level})
                    }
                    break;
                case"center":
                    if (k) {
                        p.css({left: j.left - (p.outerWidth() / 2 - h.outerWidth() / 2 - f[0] / 2)})
                    } else {
                        p.css({left: j.left - (p.outerWidth() / 2 - h.outerWidth() / 2 - f[0] / 2)});
                        u.css("left", p.outerWidth())
                    }
                ...
                if (p != null) {
                    if (k) {
                        ...
                        if (t.animationShowDuration == 0) {
                            ...
                            u.animate({top: o}, t.animationShowDuration, t.easing, function () {
                                s.isOpen = true;
                                a.jqx.aria(a(s.element), "aria-expanded", true);
                                t._raiseEvent("0", s)
                            })
                        ...
                        if (t.animationShowDuration == 0) {
                            ...
                            u.animate({left: g}, t.animationShowDuration, t.easing, function () {
                                t._raiseEvent("0", s);
                                s.isOpen = true;
                                a.jqx.aria(a(s.element), "aria-expanded", true)
                            })
            ...
            a.each(this.items, function () {
                ...
                f.addHandler(m, "click", function (v) {
                    ...
                    f._raiseEvent("2", {item: q.element, event: v});
                    if (!f.autoOpen) {
                        if (q.level > 0) {
                        ...
                        if (!e) {
                            ...
                            f.addHandler(m, "mouseleave", function (t) {
                                if (f.autoCloseOnMouseLeave) {
                                    ...
                                    var s = {left: parseInt(t.pageX), top: parseInt(t.pageY)};
                                    var v = {
